...
conexiones_activas: Dict[str, List[WebSocket]] = {canal: [] for canal in CANALES_VALIDOS}
...
def login(data: dict):
    ...
    user_id, alias = user
    return {"status": "success", "user_id": user_id, "alias": alias, "canales": CANALES_VALIDOS}
